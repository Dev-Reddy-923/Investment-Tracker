    ...
    <div className="flex flex-col gap-8 w-full max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-zinc-500 text-sm mt-1 max-w-2xl">
          Chart and P&amp;L use <strong className="text-zinc-400">Nippon India ETF Nifty 50 BeES</strong> (
          {NSE_NIFTY_ETF}) — same Nifty 50 index as other Nifty 50 funds/ETFs. Daily prices from public
      ...
      <TradingViewWidget
        title="NIFTYBEES — Nifty 50 BeES (daily)"
